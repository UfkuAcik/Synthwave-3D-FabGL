...
void VGAController::rawFillRow(int y, int x1, int x2, RGB888 color)
{
...
// parameters not checked
void VGAController::rawFillRow(int y, int x1, int x2, uint8_t pattern)
{
...
// parameters not checked
void VGAController::rawInvertRow(int y, int x1, int x2)
{
  auto row = m_viewPort[y];
  for (int x = x1; x <= x2; ++x) {
...
// parameters not checked
void VGAController::swapRows(int yA, int yB, int x1, int x2)
{
...
void VGAController::clear(Rect & updateRect)
{
...
void VGAController::VScroll(int scroll, Rect & updateRect)
{
...
void VGAController::HScroll(int scroll, Rect & updateRect)
{
  hideSprites(updateRect);
...
void VGAController::drawGlyph(Glyph const & glyph, GlyphOptions glyphOptions, RGB888 penColor, RGB888 brushColor, Rect & updateRect)
{
...
void VGAController::invertRect(Rect const & rect, Rect & updateRect)
{
...
void VGAController::swapFGBG(Rect const & rect, Rect & updateRect)
{
...
void VGAController::copyRect(Rect const & source, Rect & updateRect)
{
